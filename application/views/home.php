...
<body class="hold-transition sidebar-mini -bg-warning">
<!-- navbar -->
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="<?php echo base_url('masuk') ?>" class="small-box-footer"> <i class="fa fa-arrow-circle"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="<?php echo base_url('keluar') ?>" class="small-box-footer"><i class="fa fa-arrow-circle"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="<?php echo base_url('jeniskendaraan') ?>" class="small-box-footer"><i class="fa fa-arrow-circle"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              ...
              <a href="<?php echo base_url('admin') ?>" class="small-box-footer"><i class="fa fa-arrow-circle-"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
